...
class PoseDetector:
    ...
    def process(self, frame_raw: np.ndarray) -> tuple[np.ndarray, DetectionResult]:
        ...
        flipped_boxes = np.array(flipped_boxes)
