...
class MainWindow(QMainWindow):
    ...
    def _build_sidebar(self) -> QWidget:
        ...
        vbox.addWidget(div); vbox.addSpacing(8)
    ...
    def _build_content(self) -> QWidget:
        ...
        for key, page in [("dashboard", db_page), ("camera", cam_page),
                          ("calibration", cal_page), ("detection", det_page),
                          ("history", hist_page), ("notification", notif_page),
                          ("settings", sett_page)]:
            self._stack.addWidget(page); self._page_map[key] = page
